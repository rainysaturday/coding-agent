...
## Acceptance Criteria
- [x] Tool named `write_file` is available
- [x] Accepts file path and content as input parameters
- [x] Writes content to specified file
- [x] Creates file if it does not exist
- [x] Overwrites file if it exists
