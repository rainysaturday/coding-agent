...
## Acceptance Criteria
- [x] Tool named `insert_lines` is available
- [x] Accepts file path as input parameter
- [x] Accepts line number as input parameter (1-indexed position to insert before)
- [x] Accepts lines to insert as input parameter
- [x] Inserts lines before the specified line number
- [x] Inserting at line 1 inserts at beginning of file
- [x] Inserting beyond file end appends to end of file
- [x] Existing lines are shifted down after insertion
- [x] Creates file if it does not exist
- [x] Handles permission errors gracefully
- [x] Handles disk full errors gracefully
- [x] Returns confirmation of insertion with details
