...
## Acceptance Criteria
- [x] Tool named `read_lines` is available
- [x] Accepts file path as input parameter
- [x] Accepts start line number as input parameter (1-indexed)
- [x] Accepts end line number as input parameter (1-indexed)
- [x] Returns only the specified line range
- [x] Handles start > end by returning empty result or error
- [x] Handles start line beyond file end gracefully
- [x] Handles end line beyond file end by reading to end of file
- [x] Handles file not found errors gracefully
- [x] Handles permission errors gracefully
- [x] Returns line numbers with content for reference
